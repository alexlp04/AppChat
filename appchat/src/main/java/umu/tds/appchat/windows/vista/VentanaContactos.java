...
public class VentanaContactos extends JFrame {
	...
	public VentanaContactos(VentanaPrincipal v) {
		...
		listGrupo.setCellRenderer(new ContactCellRenderer()); 
		...
		btnVolver.addActionListener(e -> cerrarVentanaContactos());
		moveButtonsPanel.add(btnVolver);
	...
	private void manejarSeleccionContacto() {
		if (state.equals(Estado.CONTACTOS)) {
			...
			if (contactoSeleccionado instanceof Grupo) {
				...
				btnVolver.setText("Salir del grupo");
